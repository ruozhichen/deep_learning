...
tf.flags.DEFINE_string("model_dir", 'd:\\Tencent\\code\\data\\model_dnn', "model check point dir")
...
tf.flags.DEFINE_integer("num_class", 2, "training steps")
...
def build_model_estimator(num_class):
    ...
    # tf_config = tf.estimator.RunConfig(save_checkpoints_steps=500)
...
def main(idx):
    ...
    model = build_model_estimator(FLAGS.num_class)
    ...
    if FLAGS.task_type == 'train':
        ...
        with open(FLAGS.data_dir+"\\res\\%s_res_%d.txt" % (FLAGS.label, idx), "w") as fout:
